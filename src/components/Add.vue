  ...
  <div class="add container">
    ...
    <form @submit.prevent="addCustomer">
			...
			<div class="well">
					...
					<div class="form-group">
						<label>Phone</label>
						<input type="text" inputmode="tel" class="form-control" placeholder="Phone" v-model.number="customer.phone">
					</div>
			</div>
    ...
    methods: {
			addCustomer(e){
				if(!this.customer.firstName || !this.customer.lastName || !this.customer.email){
					...
					axios.post('https://radiuss.herokuapp.com/api/customers', newCustomer)
					.then((response) => {
